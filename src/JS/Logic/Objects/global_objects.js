...
enemyMokepons.push(Raykiou,Joka,Crabster,Quetzal,Rocker,Truthler);//* Here we are using our spread operator to take another arrays with our mokepons for use it in our enemy atacks
